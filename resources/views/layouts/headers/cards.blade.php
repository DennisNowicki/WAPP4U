                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0">{{count($applications)}}</span>
                                </div>
                                <div class="col-auto">
                            ...
                            <p class="mt-3 mb-0 text-muted text-sm">
                                <span class="text-danger mr-2">{{ count($notFinished)}}</span>
                                <span class="text-nowrap">not completed</span>
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0">{{ count($contact)}}</span>
                                </div>
                                <div class="col-auto">
